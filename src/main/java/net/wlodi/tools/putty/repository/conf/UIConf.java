...
public class UIConf {
    ...
    public static final int MAIN_WINDOW_WIDTH = 1028;
    public static final boolean MAIN_WINDOW_RESIZABLE = true;
    
    public static final int APP_WINDOW_DIALOG_HEIGHT = 300;
    ...
    public static final Color DEFAULT_PANEL_BORDER_COLOR = Color.GRAY;
    public static final Color DEFAULT_LINE_COLOR = new Color( 255, 255, 255 );
